...
Suite *suite_my_sum() {
  Suite *s;
  TCase *tc;
  s = suite_create("my_sum_matrix");
  tc = tcase_create("case_sum_matrix");

  tcase_add_test(tc, my_sum_test_1);
  tcase_add_test(tc, my_sum_test_2);
  tcase_add_test(tc, my_sum_test_3);
